...
// Todo: comfirm fontsMetaDataJSON with zod????
...
familyMetaDataJSON.forEach(
  ({ family, subsets, fonts, axes }: ExtractedFamilyMetaData) => {
    ...
    | {
        ...
        variableWeight?: ${
          wghtAxis
            ? `"all" | { from: ${wghtAxis.min}, to: ${wghtAxis.max}}`
            : "never"
        },
        preload?: boolean,
